        ...
        e.RESET = "affix affix-top affix-bottom", e.DEFAULTS = {
            ...
            if (this.$element.is(":visible")) {
                ...
                if (this.affixed !== l) {
                    ...
                    this.$element.trigger(c), c.isDefaultPrevented() || (this.affixed = l, this.unpin = "bottom" == l ? this.getPinnedOffset() : null, this.$element.removeClass(e.RESET).addClass(h).trigger(t.Event(h.replace("affix", "affixed"))), "bottom" == l && this.$element.offset({
                        top: s.top
                    }))
                }
            }
    ...
    +
        function (t) {
            ...
            t.fn.collapse = function (i) {
                ...
                var i, o = t(this),
                    s = o.attr("data-target") || e.preventDefault() || (i = o.attr("href")) && i.replace(/.*(?=#[^\s]+$)/, ""),
                    n = t(s),
    ...
    +
        function (t) {
            ...
            e.prototype.show = function () {
                ...
                var n = i.find("> .active"),
                    a = o && t.support.transition && n.hasClass("fade");
            ...
            e.DEFAULTS = {
                ...
                this.$body.find(this.selector).map(function () {
                    ...
                    return n && n.length && n.is(":visible") && [
                            [n[e]().top + (!t.isWindow(i.$scrollElement.get(0)) && i.$scrollElement.scrollTop()), s]
                        ] || null
                }).sort(function (t, e) {
                    return t[0] - e[0]
                }).each(function () {
    ...
    +
        function (t) {
            ...
            e.DEFAULTS = {
                ...
                var d = c.left ? 2 * c.left - s + l : 2 * c.top - n + h,
                    p = c.left ? "left" : "top",
                ...
                var e, s, n = this,
                    a = function (t) {
                        ...
                        var e = t.originalEvent,
                            ...
                            o = e.detail || e.wheelDeltaY,
                            s = parseInt(n.$.val()) + (i > 0 || o > 0 ? n.o.step : 0 > i || 0 > o ? -n.o.step : 0);
